...
const Dashboard = () => {
  ...
  const handleUpdateStatus = async (appointmentId, status)=>{
    try {
      const {data} = await axios.put(`${appointmentId}`,{status},{withCredentials:true}
    );
          ...
          <div className="firstBox">
            ...
            <div className="content">
              ...
              <p>Lorem ipsum dolor sit, amet consectetur 
                adipisicing elit. Saepe dignissimos facere 
                placeat deleniti eaque! Placeat, expedita 
                quaerat dolorum saepe incidunt 
                laboriosam in accusantium sed voluptas.</p>
            </div>
          </div>
